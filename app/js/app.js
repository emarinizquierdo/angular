...
angular.module('myApp', ['myApp.filters', 'myApp.services', 'myApp.directives', 'flickrCarousel', 'HashBangURLs', 'amap']).
  config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/demos/01/demo/05', {templateUrl: 'partials/demo05.html', controller: OnNavigate });
